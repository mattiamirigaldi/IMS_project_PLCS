...
class ListItemsGuest extends StatefulWidget {
  const ListItemsGuest({Key? key}) : super(key: key);
  @override
...
class _ListUsersState extends State<ListItemsGuest> {
...
class ProductBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (availability == 'yes') {
      ...
      TextToShow = "Rented by another user ";
